...
--Science packs
repltech_recipe("science-pack-1", "science", {tier = 3, internal_name = "science-pack-a"})
repltech_recipe("science-pack-2", "science", {tier = 4, internal_name = "science-pack-b"})
repltech_recipe("science-pack-3", "science", {tier = 4, internal_name = "science-pack-c"})
repltech_recipe("military-science-pack", "science", {tier = 4})
repltech_recipe("production-science-pack", "science", {tier = 5})
repltech_recipe("high-tech-science-pack", "science", {tier = 5})
