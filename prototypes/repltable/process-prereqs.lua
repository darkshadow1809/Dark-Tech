    ...
    for _, current_item in pairs(current_replication.items) do
        ...
        if not current_item.pointer then
            current_item.pointer =
                data.raw['item'][current_item.name] or data.raw['tool'][current_item.name] or data.raw['repair-tool'][current_item.name] or data.raw['ammo'][current_item.name] or data.raw['armor'][current_item.name] or data.raw['capsule'][current_item.name] or data.raw['gun'][current_item.name] or
                data.raw['module'][current_item.name]
		...
		if not skip then
            ...
            elseif current_prerequisite.type == 'tech' then
                ...
                if current_prerequisite.type then
                    log(
                        '"repl-' ..
                            current_replication.name ..
                                '" has a "' .. current_prerequisite.type .. '" prerequisite named "' .. current_prerequisite.target .. '".  There is no such thing as a "' .. current_prerequisite.type .. "\" prerequisite.  It's probably just a typo but the DMR mod can't figure things out on its own."
                    )
                else
